...
function NewCard(props) {
    const { task } = props;
    // переменная состояния для попапа решения
    ...
    return (
        <>
            <li className={styles.newcard} id={task._id}>
                ...
                <button type='button' onClick={handleBookmark} className={isSaveTask ? styles.newcard__bookmark : styles.newcard__bookmarkNot}></button>
                <button type='button' onClick={handleDoneTask} className={isDoneTask ? styles.newcard__done : styles.newcard__doNot}></button>
                ...
                <div className={styles.newcard__task}>
                    ...
                    <div className={styles.newcard__statistics}>
                        <div className={styles.newcard__statisticsLike}>
                            <button type='button' onClick={handleLikeTask} className={isLikeTask ? styles.newcard__like : styles.newcard__likeNot}></button>
                            <p>{countLike}</p>
                        </div>
                ...
                <div className={styles.newcard__btns}>
                    <button type='button' className={styles.newcard__btn} onClick={handleOpen}>решение</button>
                    <button type='button' className={styles.newcard__btn}>видео</button>
                    <button type='button' className={styles.newcard__btn}>теория</button>
                </div>
            </li>
